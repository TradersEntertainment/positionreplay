...
export default tseslint.config(
  {
    ignores: [
      ...
      '**/next-env.d.ts',
      // Third-party assets served verbatim, including gif.js's worker, which is copied
      // in from node_modules at build time.
      'apps/web/public/**',
      'fixtures/**',
      'out.png',
    ],
  ...
  {
    // Plain Node build scripts. typescript-eslint turns no-undef off for .ts because
    // the compiler already covers it; .mjs gets no such help, so the globals it uses
    // are declared rather than the rule switched off wholesale.
    files: ['**/*.mjs'],
    languageOptions: {
      globals: {
        console: 'readonly',
