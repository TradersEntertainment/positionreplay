 ...
 *
 * The base64url codec lives in base64url.ts, shared with manual.ts — it is hand-rolled
 * rather than reached for from Node's Buffer or the browser's btoa because this package
 * must run unchanged in a browser, in Node, and in the M8 export worker.
 */
